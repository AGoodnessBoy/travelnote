...
public class ImageUpLoadAdapter extends BaseAdapter {
    ...
    private static final String TAG = ImageUpLoadAdapter.class.getSimpleName();



    public ImageUpLoadAdapter(Context context, List<Bitmap> data, GridView mGridView){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Holder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.girditem, null);
            holder = new Holder();
